...
export default function Home() {
  return (
    <div className="min-h-screen flex justify-start items-start flex-col">
      ...
      {/* Under Maintainance */}
      <h1 className="bg-neutral-50 p-5 w-full text-md md:text-2xl font-bold text-red-600 text-center border border-red-600">
        Website is under maintainance
      </h1>

      {/* English Text Content */}
      <div className="px-5 py-10 text-start text-base md:text-2xl">
        <p>🌟 Urgent Appeal for Donations – Al-Syed Welfare Foundation 🌟
          ...
          <br /> <br />
          Donate generously and join our mission:
      ...
      <span className="h-px w-full bg-amber-400"></span>
