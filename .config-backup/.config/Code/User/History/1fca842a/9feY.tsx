...
export default function Home() {
  return (
    <div className="min-h-screen flex justify-start items-start flex-col gap-5">
      <nav className="flex justify-center items-center gap-5 border-b border-amber-400 p-5">
        <Image src={logo} alt="Logo" className="max-w-20" />
        <h1>Al Sayed Welfare Foundation</h1>
      </nav>
