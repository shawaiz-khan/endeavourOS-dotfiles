...
export default function Home() {
  return (
    <div className="min-h-screen flex justify-start items-start flex-col">
      ...
      <nav className="flex justify-center items-center w-full gap-p-5">
        <Image src={logo} alt="Logo" className="max-w-20" />
        <h1 className="font-bold text-xl">Al Sayed Welfare Foundation</h1>
      </nav>

      <h1 className="bg-neutral-50 p-5 w-full text-md font-bold text-red-600 text-center border-b border-red-600">
