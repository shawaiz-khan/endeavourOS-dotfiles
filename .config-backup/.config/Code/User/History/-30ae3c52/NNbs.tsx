...
const RegisterScreen = () => {
    return (
        <View className='px-5 flex-1 w-full flex justify-center items-center flex-col gap-5 max-w-sm mx-auto'>
            {/* Main Title */}
            <View className='flex justify-center items-center gap-8 max-w-72 mx-auto'>
                ...
                <Text className='text-2xl text-neutral-900 text-center leading-none tracking-tight font-bold'>
            ...
            <View className='w-full flex flex-col gap-3'>
                ...
                <View className='flex justify-center items-start'>
                    ...
                    <TextInput
                        className='border-2 border-neutral-400 focus:border-neutral-900 focus:outline-none rounded-md w-full py-3 px-5'
